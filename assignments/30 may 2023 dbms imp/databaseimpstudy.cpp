...
public:
    ...
    int readline()
    {
        ...
        ifstream readfile("convertcsv.csv");
        string word, line;
    ...
    void datadisplay()
    {
        ...
        while (getline(file2, line))
        {
            ...
            while (getline(obj, word, ','))
            {
                data.edata.push_back(word);
                count3++;
            }
            eedata.push_back(data);
            count4++;
        }
        file2.close();
        fflush(stdout);
        ...
        cin >> n2;
        cout << "Entry no " << n2 << " of " << columnme[n1 - 1] << " is " << eedata[n2 - 1].edata[n1-1];
    }
};
int main()
{
